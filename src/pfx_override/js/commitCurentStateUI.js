...
/* ----- Commit Handler with modal-based confirm + result ----- */
...
document.getElementById("refresh-branch").onclick = () =>
  runGitSync(
    "pull",
    "Refresh Branch?",
    "Fetch and rebase from remote? Unsaved local changes may cause conflicts."
  );
